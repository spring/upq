...
api = "https://springfiles.springrts.com/json.php"
...
r = requests.get(api + "?springname=DeltaSiegeDry")
...
r = requests.get(api + "?springname=spring%20105.0&category=engine_windows64")
assert(DictEquals(expected, r.json()))
